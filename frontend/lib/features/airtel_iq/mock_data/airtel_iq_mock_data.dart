...
class AirtelIqMockData {
  static const List<AirtelProduct> products = [
    AirtelProduct(
      ...
      shortDescription:
          'Omni-channel tool for field force with WhatsApp integration and virtual PBX.',
      overview:
          'IQ Business Connect provides a unified communication app (Vonage Business app) for mobile and desktop, enabling clear, tracked communication using Virtual Mobile Numbers (VMN). It replaces unmonitored personal numbers with a secure, managed PBX-like system.',
      businessBenefits: [
    ...
    AirtelProduct(
      ...
      category: 'Mobility',
      shortDescription:
          'Enterprise mobility plans featuring 5G Plus, Perplexity Pro AI, and Trace Mate.',
      overview:
          'Airtel Corporate Postpaid offers robust mobile data and voice plans designed for modern hybrid and remote work. It leverages the Airtel 5G Plus network and includes AI-powered fraud protection at the network level.',
      businessBenefits: [
  ...
  static const List<KnowledgeArticle> articles = [
    ...
    KnowledgeArticle(
      ...
      category: 'Security',
      summary:
          'Understanding Airtel\'s AI-powered Fraud Detection solution built into the network.',
      readTime: '4 min read',
      content:
          'Airtel is the only telco in India offering intelligent link protection at the network level. The AI-powered Fraud Detection solution detects and blocks phishing attacks and malicious links in real time across browsers, emails, and apps like WhatsApp, Instagram, and Telegram. There are no apps to install, no tools to configure, and no setup required. It automatically protects all enterprise users from spam, real-time fraud, and malicious links.',
      keyTakeaways: [
    ...
    KnowledgeArticle(
      ...
      category: 'Mobility',
      summary:
          'Why Airtel World pass is the smarter choice compared to local SIMs.',
      readTime: '5 min read',
      content:
          'Airtel World pass is one pack for the world, covering 184 countries (including layover locations). It requires no extra documents, offers usage tracking, and alerts for financial safety. Compared to local SIMs or competitors (which can be 60% more expensive and cover fewer countries), Airtel automatically activates the pack when you land. It includes unlimited data (with FUP throttle) and free incoming SMS.',
      keyTakeaways: [
  ...
  static const List<FaqItem> faqs = [
    FaqItem(
      ...
      answer:
          'Airtel offers a Data Rollover feature. Unused data from the previous month is added to the current month\'s allowance (applicable on specific plans). Note that plan downgrades lead to the loss of accumulated data.',
    ),
    FaqItem(
      id: 'f2',
      category: 'Mobility',
      ...
      answer:
          'Corporate Plans include a 12-month subscription of Perplexity Pro AI worth ₹17,000 for a year at no extra cost, enabling employees to analyze complex files and receive real-time citations.',
    ),
    FaqItem(
      id: 'f3',
      category: 'Unified Communications',
      question:
          'What is the cost of a Virtual Mobile Number (VMN) on IQ Business Connect?',
    ...
    FaqItem(
      ...
      answer:
          'With IQ Business Connect, the numbers are owned by the enterprise. The business retains the contact numbers and customer data, ensuring communication consistency and security even if an employee switches jobs.',
    ),
    FaqItem(
      id: 'f5',
      category: 'Mobility',
      ...
      answer:
          'Trace Mate is a resource tracking tool that allows companies to easily track their manpower and location over a utility, enhancing accountability, time management, and safety.',
    ),
  ];
  ...
  static const List<SalesPlaybook> playbooks = [
    SalesPlaybook(
      ...
      overview:
          'Selling communication solutions to BFS clients who prioritize security, relationship continuity, and operational efficiency.',
      painPoints: [
    ...
    SalesPlaybook(
      ...
      overview:
          'Targeting companies that deploy large field forces requiring reliable connectivity and tracking.',
      painPoints: [
  ...
  static const List<Objection> objections = [
    Objection(
      ...
      suggestedFollowUp:
          'Are you currently paying separately for enterprise AI tools or mobile security software?',
    ),
    Objection(
      id: 'o2',
      ...
      recommendedResponse:
          'Competitor packs are often 60% more expensive when factoring in the limited coverage (they cover ~81 countries vs our 184). Additionally, their packs often require you to specify the exact date of travel, whereas Airtel World Pass auto-activates when you land and covers layover destinations natively.',
      suggestedFollowUp:
          'Have your executives ever faced bill shocks or lack of coverage during layovers in destinations like Dubai?',
    ),
    Objection(
      id: 'o3',
      category: 'Technical Concerns',
      objection:
          'Setting up a new PBX system will require heavy Capex and downtime.',
      recommendedResponse:
          'That is exactly why we introduced Airtel IQ Business Connect. It is a completely cloud-based Virtual PBX. There is zero heavy Capex required for on-premise deployment, and your team can simply download the Vonage Business app on their existing smartphones and desktops.',
      suggestedFollowUp:
          'Would a cloud-based solution that activates in days rather than weeks align better with your IT budget?',
    ),
    Objection(
      id: 'o4',
      category: 'Security',
      ...
      recommendedResponse:
          'MDM is great for device management, but our AI-powered Fraud Detection operates at the network level. It detects and blocks phishing attacks and malicious links in real-time across browsers and apps (like WhatsApp) before they even reach the device OS. It acts as a zero-setup first line of defense.',
      suggestedFollowUp:
          'How often do your employees click links in personal WhatsApp messages on their corporate devices?',
    ),
  ];
}
